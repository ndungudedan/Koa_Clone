...
/// steps. Steppers are particularly useful in the case of forms where one CustomStep
    ...
    return Container(
      ...
      child: Center(
        child: SizedBox(
          ...
          child: CustomPaint(
            painter: _CustomTrianglePainter(
...
class _CustomTrianglePainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_CustomTrianglePainter oldPainter) {
